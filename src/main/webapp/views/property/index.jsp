...
<security:authorize access="hasAnyRole('TENANT')">
    ...
    <jstl:if test="${empty user.creditCard}">
        <p><spring:message code="registercreditmakerequests" /> <br>
        <a href="http://localhost:8080/actor/creditcard/edit.do">http://localhost:8080/actor/creditcard/edit.do</a></p>
    </jstl:if>
</security:authorize>
